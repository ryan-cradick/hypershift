...
func (rp CommonRegistryProvider) Reconcile(ctx context.Context) error {
	...
	if rp.capChecker.Has(capabilities.CapabilityICSP) || rp.capChecker.Has(capabilities.CapabilityIDMS) {
		imageRegistryMirrors, err = GetAllImageRegistryMirrors(ctx, rp.client, rp.capChecker.Has(capabilities.CapabilityIDMS), rp.capChecker.Has(capabilities.CapabilityICSP))
		if err != nil {
